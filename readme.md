<div style="display: flex">
  <img title="data" height="300" src="./images/data.png" style="
  border-radius: 50px;
  ...
  <h1 style="font-size: 4em"> Hello World!!!! <br> Welcome to my Github Profile </h1>
  <p>This is my github profile where I have uploaded and will upload my projects.</p>
  </div>
</div>
<br>
<br>
...
- [BeautifulSoup Course freecodecamp](https://github.com/webscraping-python/BeautifulSoup-Course) <img title="inprogress" style="margin-bottom: -10px" height="30" src="./images/inprogress.png">
...
- [Predict Fare of Airlines](https://github.com/Data-Analysis-Projects-Udemy/Project-6-Predict-Fare-of-Airlines-) <img title="inprogress" style="margin-bottom: -20px" height="30" src="./images/inprogress.png">
